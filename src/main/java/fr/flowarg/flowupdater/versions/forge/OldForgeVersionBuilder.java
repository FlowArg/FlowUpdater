 ...
 */
public class OldForgeVersionBuilder extends ModLoaderVersionBuilder<AbstractForgeVersion, OldForgeVersionBuilder>
{
    private final ForgeVersionType type;

    public OldForgeVersionBuilder(ForgeVersionType type)
    {
        this.type = type;
    }
     ...
     * @return the builder.
     */
    public OldForgeVersionBuilder withForgeVersion(String forgeVersion)
    {
     ...
     * @return the builder.
     */
    public OldForgeVersionBuilder withOptiFine(OptiFineInfo optiFineInfo)
    {
